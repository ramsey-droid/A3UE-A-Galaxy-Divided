		...
		class handgunsKND 
		{
			...
			ITEM(knd_pistol_a180_F, 250, PISTOL_STOCK);
			ITEM(knd_A300_Pistol_F, 200, PISTOL_STOCK);
			ITEM(knd_e851_f, 200, PISTOL_STOCK);
			ITEM(knd_e851_dualies_f, 250, PISTOL_STOCK);
			ITEM(KND_KGoodBye, 300, PISTOL_STOCK);
			ITEM(knd_silverhand, 300, PISTOL_STOCK);
			ITEM(knd_dl40, 200, PISTOL_STOCK);
			ITEM(knd_dl44, 250, PISTOL_STOCK);
			ITEM(knd_de10, 200, PISTOL_STOCK);
		};

		class meleeKND
		{
			displayName = "Kandosii Melee Weapons";
			picture = "a3\ui_f\data\gui\Rsc\RscDisplayArsenal\itemMelee_ca.paa";

			ITEM(knd_messer1, 350, 10);
			ITEM(knd_gaffi, 100, 10);
			ITEM(knd_beskad, 200, 10);
			ITEM(knd_bat, 80, 10);
			ITEM(knd_hammer, 150, 10);
			ITEM(knd_orikad, 400, 10);
		};
		...
		class sniperRifles3AS 
		{
			...
			ITEM(knd_amban_F, 1600, RIFLE_STOCK);

			ITEM(knd_cycler_F, 1400, RIFLE_STOCK);
			ITEM(knd_westar55_sniper_f, 1200, RIFLE_STOCK);
		...
		class smg3AS 
		{
			...
			ITEM(knd_galaar_F, 650, RIFLE_STOCK);
