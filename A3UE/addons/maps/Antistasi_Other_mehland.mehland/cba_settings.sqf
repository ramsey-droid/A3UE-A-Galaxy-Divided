...
NCA_core_broadcastHVTDeath = 0;
NCA_equipment_lowlightDefaultBrightnessSetting = 0.85;
NCA_equipment_satelliteAntennaRadius = 5;
NCA_vehicles_allowTextureSwitching = true;
NCA_vehicles_disableAutoVectoring = false;

// 3AS
fusioncutter_deCrewSimple = true;
fusioncutter_heavyAug = 50;
fusioncutter_largeList = "[""3AS_MTT"",""3AS_ATT_Red"",""3AS_GAT""]";
fusioncutter_randomFail = 10;
fusioncutter_rateFast = 1;
fusioncutter_rateFull = 1;
fusioncutter_ratesplice = 1;
fusioncutter_timeDoor = "30";
fusioncutter_timeWreck = "180";
...
force menu_framework_image = "\x\A3UE\addons\main_menu\data\backgrounds\images\snowtrooper_clone_co.jpg";
