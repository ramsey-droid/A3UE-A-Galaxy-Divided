...
["name", "Mandalorians"] call _fnc_saveToTemplate; 						//this line determines the faction name -- Example: ["name", "NATO"] - ENTER ONLY ONE OPTION
...
["vehiclesBasic", ["KND_RAT"]] call _fnc_saveToTemplate; 			//this line determines basic vehicles, the lightest kind available. -- Example: ["vehiclesBasic", ["B_Quadbike_01_F"]] -- Array, can contain multiple assets
...
["vehiclesLightArmed",["KND_RAT"]] call _fnc_saveToTemplate; 		//this line determines light and armed vehicles -- Example: ["vehiclesLightArmed",["B_MRAP_01_hmg_F", "B_MRAP_01_gmg_F"]] -- Array, can contain multiple assets
["vehiclesTrucks", ["KND_RAT"]] call _fnc_saveToTemplate; 			//this line determines the trucks -- Example: ["vehiclesTrucks", ["B_Truck_01_transport_F", "B_Truck_01_covered_F"]] -- Array, can contain multiple assets
...
["vehiclesAmmoTrucks", ["knd_px10_r3"]] call _fnc_saveToTemplate; 		//this line determines ammo trucks -- Example: ["vehiclesAmmoTrucks", ["B_Truck_01_ammo_F"]] -- Array, can contain multiple assets
["vehiclesRepairTrucks", ["knd_px10_r3"]] call _fnc_saveToTemplate; 		//this line determines repair trucks -- Example: ["vehiclesRepairTrucks", ["B_Truck_01_Repair_F"]] -- Array, can contain multiple assets
["vehiclesFuelTrucks", ["knd_px10_r3"]] call _fnc_saveToTemplate;		//this line determines fuel trucks -- Array, can contain multiple assets
["vehiclesMedical", []] call _fnc_saveToTemplate;			//this line determines medical vehicles -- Array, can contain multiple assets
["vehiclesAPCs", ["KND_RAT"]] call _fnc_saveToTemplate; 				//this line determines APCs -- Example: ["vehiclesAPCs", ["B_APC_Tracked_01_rcws_F", "B_APC_Tracked_01_CRV_F"]] -- Array, can contain multiple assets
["vehiclesTanks", ["3AS_ATTE_Ryloth"]] call _fnc_saveToTemplate; 			//this line determines tanks -- Example: ["vehiclesTanks", ["B_MBT_01_cannon_F", "B_MBT_01_TUSK_F"]] -- Array, can contain multiple assets
...
["vehiclesLightAPCs", ["KND_RAT"]] call _fnc_saveToTemplate;			//this line determines light APCs
...
["vehiclesPlanesCAS", ["KND_Z95_VTOL_Dynamic_F"]] call _fnc_saveToTemplate; 		//this line determines CAS planes -- Example: ["vehiclesPlanesCAS", ["B_Plane_CAS_01_dynamicLoadout_F"]] -- Array, can contain multiple assets
["vehiclesPlanesAA", ["knd_FangFighter_VTOL_Dynamic_F","knd_ETA2_VTOL_Dynamic_F"]] call _fnc_saveToTemplate; 			//this line determines air supperiority planes -- Example: ["vehiclesPlanesAA", ["B_Plane_Fighter_01_F"]] -- Array, can contain multiple assets
["vehiclesPlanesTransport", ["knd_KomrkFighter_VTOL_Dynamic_F"]] call _fnc_saveToTemplate; 	//this line determines transport planes -- Example: ["vehiclesPlanesTransport", ["B_T_VTOL_01_infantry_F"]] -- Array, can contain multiple assets

["vehiclesHelisLight", ["knd_KomrkFighter_VTOL_Dynamic_F"]] call _fnc_saveToTemplate; 		//this line determines light helis -- Example: ["vehiclesHelisLight", ["B_Heli_Light_01_F"]] -- Array, can contain multiple assets
["vehiclesHelisTransport", ["knd_KomrkFighter_VTOL_Dynamic_F"]] call _fnc_saveToTemplate; 	//this line determines transport helis -- Example: ["vehiclesHelisTransport", ["B_Heli_Transport_01_F"]] -- Array, can contain multiple assets
["vehiclesHelisLightAttack", ["knd_KomrkFighter_VTOL_Dynamic_F"]] call _fnc_saveToTemplate;		// this line determines light attack helicopters
["vehiclesHelisAttack", ["knd_KomrkFighter_VTOL_Dynamic_F"]] call _fnc_saveToTemplate; 		//this line determines attack helis -- Example: ["vehiclesHelisAttack", ["B_Heli_Attack_01_F"]] -- Array, can contain multiple assets
...
["sandbagRound", "3AS_BoxBarricade6"] call _fnc_saveToTemplate;
...
["variants", [
    ["knd_FangFighter_VTOL_Dynamic_F", ["factory", 1]],
    ["KND_Z95_VTOL_Dynamic_F", ["haldor", 1]]
...
_loadoutData set ["ATLaunchers", ["knd_rps6"]];
...
_loadoutData set ["sniVests", ["knd_vest_akior_2"]];
_loadoutData set ["backpacks", []];					//don't fill this line - this is only to set the variable
_loadoutData set ["longRangeRadios", ["knd_backpack_Clone_SpecOps_Sonar"]];
_loadoutData set ["atBackpacks", ["knd_backpack_Clone_Heavy"]];
...
_loadoutData set ["glasses", ["knd_knife_holster"]];	//cosmetics
_loadoutData set ["goggles", ["knd_knife_holster"]];		//cosmetics
...
["knd_amban_old_F", "", "", "", ["knd_mag_amban"], [], ""]
]];
_eliteLoadoutData set ["rifles", [
["knd_thompson_UGL_F", "", "acc_flashlight", "knd_Holo_optic", ["knd_mag_JD41"], [], ""],
["knd_VORNSK_F", "", "acc_flashlight", "", ["knd_VORNSK_mag"], [], ""]
]];
_eliteLoadoutData set ["carbines", [
["knd_westar55_carbineRifle_wood_f", "", "", "Sknd_Holo_optic_WestarTwo", ["knd_mag_westar55_carbine"], [], ""]
]];
_eliteLoadoutData set ["grenadeLaunchers", [
["knd_westar55_saw_wood_f", "", "", "", ["knd_mag_westar55_lmg"], [], ""]
]];
_eliteLoadoutData set ["SMGs", [
["knd_galaar_F", "", "", "", ["knd_mag_galaar"], [], ""]
]];
...
["knd_westar55_saw_f", "", "", "knd_Holo_optic_WestarTwo", ["knd_mag_westar55_lmg"], [], ""],
["knd_westar55_carbine_f", "", "", "knd_w55a_scopeLong_attachment", ["knd_mag_westar55_carbine"], [], ""]
]];
_militaryLoadoutData set ["rifles", [
["knd_el16", "", "", "", ["knd_el16_mag"], [], ""],
["knd_galaar_old_f", "", "", "", ["knd_mag_galaar10"], [], ""],
["knd_ee4", "", "", "", ["knd_EE4_mag"], [], ""]
]];
_militaryLoadoutData set ["carbines", [
["knd_EE3", "", "acc_flashlight", "", ["knd_EE3_mag"], [], ""],
["KND_TL50_Base", "", "acc_flashlight", "knd_Holo_optic", ["knd_mag_TL50"], [], ""],
["knd_ppsh", "", "acc_flashlight", "", ["knd_ppsh_mag"], [], ""]
]];
_militaryLoadoutData set ["grenadeLaunchers", [
["knd_relby_sap", "", "", "", ["knd_ion_slugs"], [], ""],
["knd_spacek_UGL", "", "", "", ["knd_spacek_mag"], ["knd_mag_3GL_green"], ""]
]];
...
_policeLoadoutData set ["uniforms", ["knd_rogue_light","knd_rogue"]];
_policeLoadoutData set ["vests", ["knd_vest_rogue"]];
private _helmets = ["knd_helmet_classic"];
if (_hasLawsOfWar) then {
    _helmets pushBack "knd_helmet_classic";
};
_policeLoadoutData set ["helmets", _helmets];

_policeLoadoutData set ["SMGs", [
["knd_galaar_old_f", "", "acc_flashlight", "", [], [], ""],
["knd_westar_bo", "", "acc_flashlight", "", [], [], ""]
]];
_policeLoadoutData set ["sidearms", ["knd_westar_bo"]];
...
["knd_thompson_UGL_NoStock_F", "", "acc_flashlight", "", ["knd_mag_JD41"], ["knd_mag_shotgun_thompson"], ""]
]];
_militiaLoadoutData set ["rifles", [
["knd_galaar_F", "", "acc_flashlight", "", ["knd_mag_galaar"], [], ""]
]];
_militiaLoadoutData set ["carbines", [
["knd_A180_Carbine_F", "", "acc_flashlight", "knd_a180_scope_attachment", ["knd_A180_pistol_mag"], [], ""],
["knd_A180_Carbine_Stockless_F", "", "acc_flashlight", "", ["knd_A180_pistol_mag"], [], ""],
["knd_A300_Carbine_Stock_F", "", "acc_flashlight", "optic_Aco", ["knd_mag_A300_Standard"], [], ""]
]];
_militiaLoadoutData set ["grenadeLaunchers", [
["knd_spacek_UGL", "", "acc_flashlight", "", ["knd_spacek_mag"], ["knd_mag_3GL_green"], ""]
]];
_militiaLoadoutData set ["SMGs", ["knd_DP23_F"]];
_militiaLoadoutData set ["machineGuns", [
["knd_ee4", "", "", "", ["knd_EE4_mag"], [], ""]
]];

private _marksmanRifles = [["knd_ee3B", "", "acc_flashlight", "", ["knd_mag_ee3B"], [], ""]];
private _sniperRifles = [["KND_RCC_Base", "", "", "", ["knd_mag_RCC_DMR"], [], ""]];

_militiaLoadoutData set ["marksmanRifles", _marksmanRifles];
_militiaLoadoutData set ["sniperRifles", _sniperRifles];
_militiaLoadoutData set ["sidearms", ["knd_westar34_f"]];
