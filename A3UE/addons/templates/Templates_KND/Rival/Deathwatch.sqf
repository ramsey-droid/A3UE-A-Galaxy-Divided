...
["nameLeader", "Pre Visla"] call _fnc_saveToTemplate;
...
["vehiclesRivalsLightArmed", ["KND_RAT"]] call _fnc_saveToTemplate;
["vehiclesRivalsTrucks", ["KND_RAT"]] call _fnc_saveToTemplate;
["vehiclesRivalsCars", ["KND_RAT"]] call _fnc_saveToTemplate;
["vehiclesRivalsAPCs", ["KND_RAT"]] call _fnc_saveToTemplate;
["vehiclesRivalsTanks", ["3AS_AAT_CIS_White"]] call _fnc_saveToTemplate;
["vehiclesRivalsHelis", ["knd_KomrkFighter_VTOL_Dynamic_F"]] call _fnc_saveToTemplate;			
...
private _tunedRifles = [
	["knd_ee3B", "", "", "", ["knd_mag_ee3B"], [], ""]
];
private _enforcerRifles = [
	["knd_thompson_UGL_NoStock_F", "", "", "", ["knd_mag_JD41"], ["knd_mag_shotgun_thompson"], ""]
];
private _carbines = [
	["knd_ppsh", "", "", "", ["knd_ppsh_mag_Big"], [], ""]
];
private _gls = [
	["knd_relby_sap", "", "", "", ["knd_ion_slugs"], [], ""]
];
private _mgs = [
	["knd_rotary", "", "", "", ["knd_rotary_mag_600"], [], ""]
];
private _marksmanRifles = [
	["knd_amban_old_F", "", "", "", ["knd_EE3_mag"], [], ""],
	["knd_g90", "", "", "", ["knd_g90_mag"], [], ""],
	["knd_cycler_F", "", "", "", ["knd_cycler_mag"], [], ""]
];
...
private _pistols = ["knd_messer1","knd_messer2","knd_beskad"];
...
_loadoutData set ["lightHELaunchers", [
	["knd_rps6", "", "", "", ["knd_mag_rps6_saclos"], [], ""]
]];
_loadoutData set ["AALaunchers", [
	["knd_rps6", "", "acc_pointer_IR", "", ["knd_mag_rps6_aa"], [], ""]
]];
...
_loadoutData set ["fullmask", ["knd_knife_holster"]];

_loadoutData set ["headgear", [
    "knd_helmet_Grunt_DeathWatch"
]];
...
_loadoutData set ["uniforms", [
	"knd_Beroya_DeathWatch","knd_Beroya_DeathWatchMedic" 
]];
_loadoutData set ["heavyUniforms", ["knd_Beroya_DeathWatchNCO"]];

private _helmets = ["knd_helmet_Grunt_DeathWatch","knd_helmet_Grunt_DeathWatch","knd_helmet_Grunt_DeathWatch","knd_helmet_Grunt_DeathWatchHVT","knd_helmet_Grunt_DeathWatchMedic","knd_helmet_Grunt_DeathWatchNCO"];

_loadoutData set ["offuniforms", ["knd_Beroya_DeathWatchHVT"]];
_loadoutData set ["vests", ["knd_belt_beroya", "knd_vest_beroya_dual_light_1h","knd_vest_akior_1","knd_vest_beroya", "knd_vest_beroya_dual", "knd_vest_beroya_dual_light"]];
_loadoutData set ["heavyVests", ["knd_vest_beroya_dual_light_1h"]];
_loadoutData set ["backpacks", ["knd_jetpack_JT12_Maxim_Light_LR","knd_jetpack_JT12_Maxim_Light", "ls_mandalorianBackpack"]];
_loadoutData set ["heavyBackpacks", ["KND_RotaryBackpack"]];
_loadoutData set ["helmets", _helmets];
_loadoutData set ["crewHelmets", ["knd_helmet_Grunt_DeathWatchNCO"]];
...
_loadoutData set ["items_medic_extras", ["knd_drone_healer"]];
...
_crewLoadoutData set ["vests", ["knd_vest_holsters_dual_light_strapless"]];
_crewLoadoutData set ["helmets", ["knd_helmet_Grunt_DeathWatchNCO"]];

private _pilotLoadoutData = _loadoutData call _fnc_copyLoadoutData;
_pilotLoadoutData set ["vests", ["knd_vest_holsters_dual_light_strapless"]];
_pilotLoadoutData set ["helmets", ["knd_helmet_Grunt_DeathWatchNCO"]];
...
private _oppressorTemplate = {
	...
	["vests"] call _fnc_setVest;
	["uniforms"] call _fnc_setUniform;
	["heavyBackpacks"] call _fnc_setBackpack;
...
private _unitTypes = [
	...
	["Mercenary", _mercenaryTemplate, [["baseClass", "O_soldier_Melee_Hybrid", false]], [_prefix, true]],
	["Minuteman", _minutemanTemplate, [["baseClass", "O_soldier_Melee_Hybrid", false]], [_prefix, true]],
	["Enforcer", _enforcerTemplate, [["baseClass", "O_soldier_Melee_Hybrid", false]], [_prefix, true]],
	["Partisan", _partisanTemplate, [["baseClass", "O_soldier_Melee_Hybrid", false]], [_prefix, true]],
	["Saboteur", _saboteurTemplate, [["baseClass", "O_soldier_Melee_Hybrid", false]], [_prefix, true]],
	...
	["SpecialistAT", _atTemplate, [["baseClass", "O_soldier_Melee_Hybrid", false]], [_prefix, true]],
	["SpecialistAA", _aaTemplate, [["baseClass", "O_soldier_Melee_Hybrid", false]], [_prefix, true]],
	["Oppressor", _oppressorTemplate, [["baseClass", "O_soldier_Melee_Hybrid", false]], [_prefix, true]],
	["Sharpshooter", _sharpshooterTemplate, [["baseClass", "O_soldier_Melee_Hybrid", false]], [_prefix, true]]
];
