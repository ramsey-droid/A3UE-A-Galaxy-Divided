...
["nameLeader", "Boc Vaso"] call _fnc_saveToTemplate;
...
["vehiclesRivalsTrucks", ["3AS_PX10_REP_UP"]] call _fnc_saveToTemplate;
["vehiclesRivalsCars", ["3AS_ISP_Transport"]] call _fnc_saveToTemplate;
["vehiclesRivalsAPCs", ["3AS_PX10_REP_UP"]] call _fnc_saveToTemplate;
["vehiclesRivalsTanks", ["3AS_AAT_Red"]] call _fnc_saveToTemplate;
["vehiclesRivalsHelis", ["ls_vehicle_laatle_transportGunship"]] call _fnc_saveToTemplate;			
...
private _rifles = [
	["AGD_Galaar15", "", "", "", ["IDA_Blaster_Cell_Power3_40Rnd_Yellow"], [], ""]
];
...
private _marksmanRifles = [
	["AGD_Galaar90", "", "", "IDA_TargetingScope", ["IDA_Blaster_Cell_Power5_5Rnd_Yellow"], [], ""]
];
...
_loadoutData set ["facewear", [
	"ls_mandalorian_rangefinder_hud"
]];
_loadoutData set ["fullmask", [	"ls_mandalorian_rangefinder_hud"]];
...
_loadoutData set ["heavyUniforms", ["ls_mandalorianUniform"]];

private _helmets = ["ls_mandalorianHelmet_elite","ls_mandalorianHelmet_armorer","ls_mandalorianHelmet_stalker","ls_mandalorianHelmet_nightowl","ls_mandalorianHelmet_executioner"];

_loadoutData set ["offuniforms", ["ls_mandalorianUniform"]];
_loadoutData set ["vests", ["ls_mandalorianVest_standard"]];
_loadoutData set ["heavyVests", ["ls_mandalorianVest_vizslaGrunt"]];
_loadoutData set ["backpacks", ["ls_mandalorianBackpack_light", "ls_mandalorianBackpack"]];
_loadoutData set ["helmets", _helmets];
_loadoutData set ["crewHelmets", ["ls_mandalorianHelmet_stalker"]];
...
_crewLoadoutData set ["vests", ["ls_mandalorianVest_standard"]];
_crewLoadoutData set ["helmets", ["ls_mandalorianHelmet_nightowl"]];

private _pilotLoadoutData = _loadoutData call _fnc_copyLoadoutData;
_pilotLoadoutData set ["vests", ["ls_mandalorianVest_standard"]];
_pilotLoadoutData set ["helmets", ["ls_mandalorianHelmet_nightowl"]];
