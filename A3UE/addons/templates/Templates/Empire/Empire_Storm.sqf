...
_eliteLoadoutData set ["Hvests", ["WM_SGT_Pauldron"]];
...
_militaryLoadoutData set ["Hvests", ["WM_SGT_Pauldron"]];
_militaryLoadoutData set ["backpacks", ["WM_TritonRuck","IDA_Imperial_Backpack_Straps"]];
...
_militiaLoadoutData set ["uniforms", ["WM_StormArmor"]];
_militiaLoadoutData set ["vests", ["IDA_KnifeHolster","IDA_Holster_1","IDA_Holster_2","ls_vest_holster","JLTS_CloneVestHolster"]];
_militiaLoadoutData set ["Hvests", ["WM_Pauldron"]];
_militiaLoadoutData set ["backpacks", ["ls_imperialBackpack_shoulderPouch","WM_Stormtrooper_Backpack"]];
_militiaLoadoutData set ["helmets", ["WM_StormHelmet"]];
