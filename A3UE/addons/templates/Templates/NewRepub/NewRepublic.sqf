...
["vehiclesLightUnarmed", ["AGD_Rebel_Speeder_Unarmed"]] call _fnc_saveToTemplate; 		//this line determines light and unarmed vehicles. -- Example: ["vehiclesLightUnarmed", ["B_MRAP_01_F"]] -- Array, can contain multiple assets
["vehiclesLightArmed",["WM_V25_Speeder","AGD_Rebel_Speeder_armed"]] call _fnc_saveToTemplate; 		//this line determines light and armed vehicles -- Example: ["vehiclesLightArmed",["B_MRAP_01_hmg_F", "B_MRAP_01_gmg_F"]] -- Array, can contain multiple assets
["vehiclesTrucks", ["AGD_NewRepub_ITT"]] call _fnc_saveToTemplate; 			//this line determines the trucks -- Example: ["vehiclesTrucks", ["B_Truck_01_transport_F", "B_Truck_01_covered_F"]] -- Array, can contain multiple assets
...
["vehiclesTanks", ["WM_AAC_Speeder_Rocket", "3AS_AAT_Rebel", "3AS_AAT_Rebel_Heavy", "3AS_ATAP_Rebel", "WM_AAC_Speeder"]] call _fnc_saveToTemplate; 			//this line determines tanks -- Example: ["vehiclesTanks", ["B_MBT_01_cannon_F", "B_MBT_01_TUSK_F"]] -- Array, can contain multiple assets
...
["vehicleSam", "3AS_DF9_AA_Grey"] call _fnc_saveToTemplate;
...
["vehiclesHelisTransport", ["3AS_Rho_IMP_F","WM_Lambda"]] call _fnc_saveToTemplate; 	//this line determines transport helis -- Example: ["vehiclesHelisTransport", ["B_Heli_Transport_01_F"]] -- Array, can contain multiple assets
...
["vehiclesMilitiaLightArmed", ["WM_V25_Speeder", "AGD_Rebel_Speeder_armed"]] call _fnc_saveToTemplate; //this line determines lightly armed militia vehicles -- Example: ["vehiclesMilitiaLightArmed", ["B_G_Offroad_01_armed_F"]] -- Array, can contain multiple assets
["vehiclesMilitiaTrucks", ["AGD_NewRepub_ITT_Logistic"]] call _fnc_saveToTemplate; 	//this line determines militia trucks (unarmed) -- Example: ["vehiclesMilitiaTrucks", ["B_G_Van_01_transport_F"]] -- Array, can contain multiple assets
["vehiclesMilitiaCars", ["AGD_Rebel_Speeder_Unarmed"]] call _fnc_saveToTemplate; 		//this line determines militia cars (unarmed) -- Example: ["vehiclesMilitiaCars", ["B_G_Offroad_01_F"]] -- Array, can contain multiple assets

["vehiclesMilitiaAPCs", ["AGD_PX10_NewRepub"]] call _fnc_saveToTemplate;     					//this line determines militia APCs

["vehiclesPolice", ["WM_V25_Speeder"]] call _fnc_saveToTemplate; 			//this line determines police cars -- Example: ["vehiclesPolice", ["B_GEN_Offroad_01_gen_F"]] -- Array, can contain multiple assets
...
_loadoutData set ["officerHats", ["ls_helmet_service"]];	//this line determines officer headgear for assassination missions
...
_loadoutData set ["atBackpacks", ["IDA_Clone_ScoutPack"]];
...
_loadoutData set ["sniHats", ["ls_helmet_cqcm_visor_newRepublic"]];
...
_eliteLoadoutData set ["backpacks", ["ls_newRepublicBackpack_chestRig","ls_newRepublicBackpack_chestRigPouch"]];
...
_militaryLoadoutData set ["backpacks", ["ls_newRepublicBackpack_chestRig", "Black_WM_Rebel_bag"]];
...
_militiaLoadoutData set ["backpacks", ["ls_newRepublicBackpack_chestRig","ls_rebelBackpack_chest_pouch"]];
...
_militiaLoadoutData set ["SMGs", ["AGD_SPK12", "AGD_SE28", "3AS_Cinnagaran_Carbine_F"]];
_militiaLoadoutData set ["machineGuns", [
["AGD_DLT19", "", "acc_flashlight", "", ["IDA_Blaster_Cell_Power3_60Rnd_Red"], [], "bipod_03_F_blk"],
["AGD_M41", "", "acc_flashlight", "", ["IDA_Blaster_Cell_Power2_100Rnd_Green"], [], ""]
]];
