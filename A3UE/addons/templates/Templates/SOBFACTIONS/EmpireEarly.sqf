...
["vehiclesHelisTransport", ["mti_factions_imp_Lambda", "mti_factions_imp_NU", "mti_factions_imp_Rho"]] call _fnc_saveToTemplate; 	//this line determines transport helis -- Example: ["vehiclesHelisTransport", ["B_Heli_Transport_01_F"]] -- Array, can contain multiple assets
["vehiclesHelisLightAttack", ["mti_factions_imp_LAATLE", "OPTRE_CMA_MHS_144_Falcon", "OPTRE_CMA_UH_144S_Falcon_DAP"]] call _fnc_saveToTemplate;		// this line determines light attack helicopters
...
_sfLoadoutData set ["uniforms", ["mti_factions_imp_uniform_Deathtrooper"]];
_sfLoadoutData set ["vests", ["mti_factions_imp_vest_Death_Vest"]];
_sfLoadoutData set ["Hvests", ["mti_factions_imp_vest_Death_Vest"]];
...
_sfLoadoutData set ["helmets", ["mti_factions_imp_helmet_Deathtrooper_Helmet"]];
...
_eliteLoadoutData set ["uniforms", ["mti_armoury_commando_uniform_Imperial", "SWLB_AiwhaTyto_Uniform"]];
...
_eliteLoadoutData set ["helmets", ["mti_armoury_commando_helmet_Imperial", "SWLB_AiwhaTyto_Helmet"]];
...
_militaryLoadoutData set ["uniforms", ["WM_P3_Triton_ARC"]];
_militaryLoadoutData set ["slUniforms", ["WM_P3_Triton_ARC"]];
_militaryLoadoutData set ["vests", ["mti_factions_imp_vest_Elite"]];
_militaryLoadoutData set ["Hvests", ["mti_factions_imp_vest_Elite", "mti_factions_imp_vest_ARC", "mti_factions_imp_vest_Marksman"]];
...
_militaryLoadoutData set ["helmets", ["mti_factions_imp_helmet_501Triton"]];
...
["mti_factions_imp_DC15A", "", "3AS_Imp_Light_E11", "3AS_Imp_Optic_1", ["mti_factions_imp_Rifle_Red_Mag"], [], ""],
["mti_factions_imp_E11", "", "3AS_Imp_Light_E11", "3AS_Imp_Optic_1", ["mti_factions_imp_Rifle_Red_Mag"], [], ""],
["mti_factions_imp_E11", "", "3AS_Imp_Light_E11", "3AS_Imp_Optic_2", ["mti_factions_imp_Rifle_Red_Mag"], [], ""],
["mti_factions_imp_E11", "", "3AS_Imp_Laser_E11", "3AS_Imp_Optic_3", ["mti_factions_imp_Rifle_Red_Mag"], [], ""],
["mti_factions_imp_E11", "", "3AS_Imp_Laser_E11", "3AS_Imp_Optic_E11", ["mti_factions_imp_Rifle_Red_Mag"], [], ""],
...
_militiaLoadoutData set ["uniforms", ["WM_P3_Triton"]];
_militiaLoadoutData set ["vests", ["mti_factions_imp_vest_Base"]];
_militiaLoadoutData set ["Hvests", ["mti_factions_imp_vest_Elite"]];
...
_militiaLoadoutData set ["helmets", ["WM_P3_TritonHelmet"]];
...
private _unitTypes = [
	["SquadLeader", _squadLeaderTemplate, [["baseClass", "mti_factions_imp_unit_ARC", true]], [_prefix]],
	["Rifleman", _riflemanTemplate, [["baseClass", "mti_factions_imp_unit_Triton", false]], [_prefix]],
	["Radioman", _radiomanTemplate, [["baseClass", "mti_factions_imp_unit_Triton", false]], [_prefix]],
	["Medic", _medicTemplate, [["baseClass", "mti_factions_imp_unit_Triton", false]], [_prefix]],
	["Engineer", _engineerTemplate, [["baseClass", "mti_factions_imp_unit_Triton", false]], [_prefix]],
	["ExplosivesExpert", _explosivesExpertTemplate, [["baseClass", "mti_factions_imp_unit_Triton", false]], [_prefix]],
	["Grenadier", _grenadierTemplate, [["baseClass", "mti_factions_imp_unit_Triton", false]], [_prefix]],
	["LAT", _latTemplate, [["baseClass", "mti_factions_imp_unit_Triton", false]], [_prefix]],
	["AT", _atTemplate, [["baseClass", "mti_factions_imp_unit_Triton", false]], [_prefix]],
	["AA", _aaTemplate, [["baseClass", "mti_factions_imp_unit_Triton", false]], [_prefix]],
	["MachineGunner", _machineGunnerTemplate, [["baseClass", "mti_factions_imp_unit_Triton", false]], [_prefix]],
	["Marksman", _marksmanTemplate, [["baseClass", "mti_factions_imp_unit_Triton", false]], [_prefix]],
	["Sniper", _sniperTemplate, [["baseClass", "mti_factions_imp_unit_Triton", false]], [_prefix]]
];
