...
_loadoutData set ["glasses", ["ls_imperial_army_shoulderPouch","ls_imperial_chestRigPouch","ls_imperial_earPiece","ls_imperial_satchel","ls_imperial_satchelOthers","AGD_AmmoPack_F","AGD_AmmoPack_Poncho_F","AGD_Pauldron_F","AGD_Poncho_F","ls_imperial_chestRig"]];	//cosmetics
_loadoutData set ["goggles", ["ls_imperial_army_shoulderPouch","ls_imperial_chestRigPouch","ls_imperial_earPiece","ls_imperial_satchel","ls_imperial_satchelOthers","AGD_AmmoPack_F","AGD_AmmoPack_Poncho_F","AGD_Pauldron_F","AGD_Poncho_F","ls_imperial_chestRig"]];		//cosmetics
...
_sfLoadoutData set ["uniforms", ["WM_ShadowArmor"]];
_sfLoadoutData set ["vests", ["WM_Pauldron"]];
_sfLoadoutData set ["Hvests", ["WM_P3_Shadow_Vest"]];
_sfLoadoutData set ["backpacks", ["ls_imperialBackpack_chestRigPouch", "ls_imperialBackpack_chestRig"]];
_sfLoadoutData set ["helmets", ["WM_ShadowHelmet"]];
...
_militiaLoadoutData set ["SMGs", ["AGD_E10", "IDA_SE28", "3AS_Cinnagaran_Carbine_F"]];
...
_militiaLoadoutData set ["sidearms", ["AGD_A260P", "IDA_EC17"]];
