...
_militiaLoadoutData set ["uniforms", ["3AS_U_Rep_ColdAssault_Armor"]];		//this line determines uniforms for militia loadouts -- Example: ["U_B_CombatUniform_mcam", "U_B_CombatUniform_mcam_tshirt"] -- Array, can contain multiple assets
_militiaLoadoutData set ["slUniforms", ["3AS_U_Rep_ColdAssault_Armor"]];
...
_militiaLoadoutData set ["helmets", ["3AS_H_ColdAssault_Helmet"]];		//this line determines helmets for police loadouts -- Example: ["H_HelmetB_camo", "H_HelmetB_desert"] -- Array, can contain multiple assets
_militiaLoadoutData set ["sniHats", ["3AS_H_ColdAssault_Helmet"]];
_militiaLoadoutData set ["slHat", ["3AS_H_ColdAssault_Helmet"]];
