...
class DOUBLES(ADDON,Nodes) 
{
    ...
    #include "Logistics\AGDNodes.hpp" //include the nodes from the different mods here
};

class DOUBLES(ADDON,Cargo) 
{
    class TRIPLES(ADDON,Cargo,Base); //import base class from antistasi
    #include "Logistics\AGDCargo.hpp" //include the cargo from the different mods here
};
