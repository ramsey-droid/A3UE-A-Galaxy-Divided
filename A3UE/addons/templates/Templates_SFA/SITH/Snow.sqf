...
["name", "Sith Empire"] call _fnc_saveToTemplate; 						//this line determines the faction name -- Example: ["name", "NATO"] - ENTER ONLY ONE OPTION
...
["flagTexture", "3AS\3as_props\Flags\Data\camo_flag_vanilla\camo_flag_vanilla_sith\camo_flag_vanilla_sith_co.paa"] call _fnc_saveToTemplate; 				//this line determines the flag texture -- Example: ["flagTexture", "\A3\Data_F\Flags\Flag_NATO_CO.paa"] - ENTER ONLY ONE OPTION
...
["vehiclesBasic", ["3AS_Fliknot_Brown"]] call _fnc_saveToTemplate; 			//this line determines basic vehicles, the lightest kind available. -- Example: ["vehiclesBasic", ["B_Quadbike_01_F"]] -- Array, can contain multiple assets
["vehiclesLightUnarmed", ["3AS_Fliknot_Brown"]] call _fnc_saveToTemplate; 		//this line determines light and unarmed vehicles. -- Example: ["vehiclesLightUnarmed", ["B_MRAP_01_F"]] -- Array, can contain multiple assets
["vehiclesLightArmed",["AGD_Sith_AAC"]] call _fnc_saveToTemplate; 		//this line determines light and armed vehicles -- Example: ["vehiclesLightArmed",["B_MRAP_01_hmg_F", "B_MRAP_01_gmg_F"]] -- Array, can contain multiple assets
["vehiclesTrucks", ["AGD_Sith_AAC"]] call _fnc_saveToTemplate; 			//this line determines the trucks -- Example: ["vehiclesTrucks", ["B_Truck_01_transport_F", "B_Truck_01_covered_F"]] -- Array, can contain multiple assets
...
["vehiclesAmmoTrucks", ["AGD_Truck_Sith_Ammo"]] call _fnc_saveToTemplate; 		//this line determines ammo trucks -- Example: ["vehiclesAmmoTrucks", ["B_Truck_01_ammo_F"]] -- Array, can contain multiple assets
["vehiclesRepairTrucks", ["AGD_Truck_Sith_Repair"]] call _fnc_saveToTemplate; 		//this line determines repair trucks -- Example: ["vehiclesRepairTrucks", ["B_Truck_01_Repair_F"]] -- Array, can contain multiple assets
["vehiclesFuelTrucks", ["AGD_Truck_Sith_Fuel"]] call _fnc_saveToTemplate;		//this line determines fuel trucks -- Array, can contain multiple assets
["vehiclesMedical", []] call _fnc_saveToTemplate;			//this line determines medical vehicles -- Array, can contain multiple assets
["vehiclesAPCs", ["AGD_Sith_AAC"]] call _fnc_saveToTemplate; 				//this line determines APCs -- Example: ["vehiclesAPCs", ["B_APC_Tracked_01_rcws_F", "B_APC_Tracked_01_CRV_F"]] -- Array, can contain multiple assets
["vehiclesTanks", ["SFA_Enforcer_Imp", "SFA_Devastator_F"]] call _fnc_saveToTemplate; 			//this line determines tanks -- Example: ["vehiclesTanks", ["B_MBT_01_cannon_F", "B_MBT_01_TUSK_F"]] -- Array, can contain multiple assets
["vehiclesAA", ["AGD_Sith_AAC_AA"]] call _fnc_saveToTemplate; 				//this line determines AA vehicles -- Example: ["vehiclesAA", ["B_APC_Tracked_01_AA_F"]] -- Array, can contain multiple assets
...
["vehiclesPlanesCAS", ["SFA_Vengeance_F"]] call _fnc_saveToTemplate; 		//this line determines CAS planes -- Example: ["vehiclesPlanesCAS", ["B_Plane_CAS_01_dynamicLoadout_F"]] -- Array, can contain multiple assets
["vehiclesPlanesAA", ["ls_vehicle_z98_grey"]] call _fnc_saveToTemplate; 			//this line determines air supperiority planes -- Example: ["vehiclesPlanesAA", ["B_Plane_Fighter_01_F"]] -- Array, can contain multiple assets
...
["vehiclesHelisLight", ["SFA_Dragonfly"]] call _fnc_saveToTemplate; 		//this line determines light helis -- Example: ["vehiclesHelisLight", ["B_Heli_Light_01_F"]] -- Array, can contain multiple assets
["vehiclesHelisTransport", ["SFA_Dragonfly"]] call _fnc_saveToTemplate; 	//this line determines transport helis -- Example: ["vehiclesHelisTransport", ["B_Heli_Transport_01_F"]] -- Array, can contain multiple assets
["vehiclesHelisLightAttack", ["SFA_Dragonfly"]] call _fnc_saveToTemplate;		// this line determines light attack helicopters
["vehiclesHelisAttack", ["SFA_Dragonfly"]] call _fnc_saveToTemplate; 		//this line determines attack helis -- Example: ["vehiclesHelisAttack", ["B_Heli_Attack_01_F"]] -- Array, can contain multiple assets

["vehiclesAirPatrol", ["SFA_Dragonfly"]] call _fnc_saveToTemplate;
...
["vehiclesMilitiaLightArmed", ["AGD_Sith_AAC"]] call _fnc_saveToTemplate; //this line determines lightly armed militia vehicles -- Example: ["vehiclesMilitiaLightArmed", ["B_G_Offroad_01_armed_F"]] -- Array, can contain multiple assets
["vehiclesMilitiaTrucks", ["AGD_Sith_AAC"]] call _fnc_saveToTemplate; 	//this line determines militia trucks (unarmed) -- Example: ["vehiclesMilitiaTrucks", ["B_G_Van_01_transport_F"]] -- Array, can contain multiple assets
["vehiclesMilitiaCars", ["3AS_Fliknot_Brown"]] call _fnc_saveToTemplate; 		//this line determines militia cars (unarmed) -- Example: ["vehiclesMilitiaCars", ["B_G_Offroad_01_F"]] -- Array, can contain multiple assets

["vehiclesMilitiaAPCs", ["AGD_Sith_AAC_AA"]] call _fnc_saveToTemplate;     					//this line determines militia APCs
...
_loadoutData set ["stormUniforms", ["SFA_Sith_Armor_Snow"]];
_loadoutData set ["stormVests", ["SFA_ImpGren_Vest"]];
_loadoutData set ["stormHats", ["SFA_Sith_Helmet_Snow"]];

_loadoutData set ["stormSniperUniforms", ["SFA_Sith_Armor_Snow"]];
_loadoutData set ["stormSniperVests", ["SFA_ImpLead_Vest"]];
_loadoutData set ["stormSniperHats", ["SFA_Sith_Helmet_Snow"]];

_loadoutData set ["traitorUniforms", ["SFA_Combat_Eng_Uniform"]];		//this line determines traitor uniforms for traitor mission
_loadoutData set ["traitorVests", ["ls_vest_holster_maroon"]];			//this line determines traitor vesets for traitor mission
_loadoutData set ["traitorHats", ["SFA_Revanite_Militant_Mask"]];			//this line determines traitor headgear for traitor missions

_loadoutData set ["officerUniforms", ["SFA_Imp_Moff"]];		//this line determines officer uniforms for assassination mission
_loadoutData set ["officerVests", ["SFA_ImpLead_Vest"]];			//this line determines officer vesets for assassination mission
_loadoutData set ["officerHats", ["SFA_Moff_hat"]];	//this line determines officer headgear for assassination missions
...
_loadoutData set ["sniVests", ["SFA_ImpGren_Vest"]];
_loadoutData set ["backpacks", []];					//don't fill this line - this is only to set the variable
_loadoutData set ["longRangeRadios", ["SFA_Sith_backpack_Snow_LR"]];
...
_sfLoadoutData set ["uniforms", ["SFA_KOTOR_Sith_Armor"]];
_sfLoadoutData set ["vests", ["ls_vest_holster_brown"]];
_sfLoadoutData set ["Hvests", ["ls_vest_holster_brown"]];
_sfLoadoutData set ["backpacks", ["ls_cloneBackpack_beltbag"]];
...
_eliteLoadoutData set ["uniforms", ["SFA_Sith_Armor_Snow"]];
_eliteLoadoutData set ["slUniforms", ["SFA_Sith_Armor_Snow"]];
_eliteLoadoutData set ["vests", ["SFA_ImpGren_Vest", "SFA_ImpMed_Vest"]];
_eliteLoadoutData set ["Hvests", ["SFA_ImpLead_Vest"]];
_eliteLoadoutData set ["backpacks", ["SFA_Sith_backpack_Snow"]];
_eliteLoadoutData set ["helmets", ["SFA_Sith_commando_Helmet_makeb", "SFA_Sith_guard_Helmet_makeb"]];
_eliteLoadoutData set ["binoculars", ["SFA_electrobinocular"]];

_eliteLoadoutData set ["slRifles", [
["SFA_Causality", "", "", "", [], [], ""],
["SFA_DLA13", "", "", "SFA_DLA13_scope", [], [], ""],
["SFA_E1_Reforged", "", "", "", [], [], ""]
]];
...
["SFA_DLA13_ugl", "", "", "", ["SFA_DLA13_mag"], ["SFA_light_proton_mag"], ""]
]];
...
_eliteLoadoutData set ["machineGuns", [
    ...
    ["SFA_T20_AC", "", "acc_flashlight", "", [], [], ""],
    ["SFA_T20_rifle", "", "acc_flashlight", "", [], [], ""],
...
_militaryLoadoutData set ["uniforms", ["SFA_Sith_Armor_Snow_light"]];
_militaryLoadoutData set ["slUniforms", ["SFA_Sith_Armor_Snow"]];
_militaryLoadoutData set ["vests", ["SFA_ImpGren_Vest", "SFA_Ammo_Sash"]];
_militaryLoadoutData set ["Hvests", ["SFA_ImpLead_Vest"]];
_militaryLoadoutData set ["backpacks", ["SFA_Sith_backpack_Snow"]];
_militaryLoadoutData set ["helmets", ["SFA_Sith_Helmet_light_snow", "SFA_Sith_Helmet_Snow"]];
...
_policeLoadoutData set ["uniforms", ["SFA_Imp_Arch"]];
_policeLoadoutData set ["vests", ["ls_vest_holster_maroon"]];
private _helmets = ["SFA_Arch_hat"];
if (_hasLawsOfWar) then {
    _helmets pushBack "SFA_Arch_hat";
};
...
_militiaLoadoutData set ["uniforms", ["SFA_Sith_Scout_Hoth"]];
_militiaLoadoutData set ["vests", ["ls_vest_holster_maroon"]];
_militiaLoadoutData set ["Hvests", ["ls_imperialVest_army_light_h"]];
_militiaLoadoutData set ["backpacks", ["ls_imperialBackpack_satchel", "ls_imperialBackpack_chestRig"]];
_militiaLoadoutData set ["helmets", ["SFA_Scout_Helmet_Hoth"]];
...
_crewLoadoutData set ["uniforms", ["SFA_Sith_Armor_Armsmaster"]];
_crewLoadoutData set ["vests", ["SFA_ImpPilot_Vest"]];
_crewLoadoutData set ["helmets", ["SFA_Sith_Helmet_Armsmaster"]];


private _pilotLoadoutData = _militaryLoadoutData call _fnc_copyLoadoutData;
_pilotLoadoutData set ["uniforms", ["SFA_Sith_Armor_SGT"]];
_pilotLoadoutData set ["vests", ["SFA_ImpPilot_Vest"]];
_pilotLoadoutData set ["helmets", ["SFA_Sith_Helmet_SGT"]];
