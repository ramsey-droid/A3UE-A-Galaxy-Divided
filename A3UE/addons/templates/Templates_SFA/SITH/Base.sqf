...
_loadoutData set ["stormUniforms", ["SFA_Sith_Armor_Engineer"]];
_loadoutData set ["stormVests", ["SFA_ImpGren_Vest"]];
_loadoutData set ["stormHats", ["SFA_Sith_Helmet_Engineer"]];

_loadoutData set ["stormSniperUniforms", ["SFA_Sith_Armor_Marksman"]];
_loadoutData set ["stormSniperVests", ["SFA_ImpLead_Vest"]];
_loadoutData set ["stormSniperHats", ["SFA_Sith_Helmet_Marksman"]];
...
_loadoutData set ["officerUniforms", ["SFA_Sith_Armor_officer"]];		//this line determines officer uniforms for assassination mission
_loadoutData set ["officerVests", ["SFA_ImpLead_Vest"]];			//this line determines officer vesets for assassination mission
_loadoutData set ["officerHats", ["SFA_Sith_Helmet_Officer"]];	//this line determines officer headgear for assassination missions
...
_loadoutData set ["longRangeRadios", ["SFA_Sith_backpack_LR"]];
...
_sfLoadoutData set ["uniforms", ["SFA_KOTOR_Sith_Armor", "SFA_KOTOR_Sith_Armor_Elite", "SFA_KOTOR_Sith_Armor_Energized", "SFA_KOTOR_Sith_Armor_OP"]];
...
_eliteLoadoutData set ["uniforms", ["SFA_Sith_Armor_Board"]];
_eliteLoadoutData set ["slUniforms", ["SFA_Sith_Armor_SF"]];
_eliteLoadoutData set ["vests", ["SFA_ImpGren_Vest", "SFA_ImpMed_Vest"]];
_eliteLoadoutData set ["Hvests", ["SFA_ImpLead_Vest"]];
_eliteLoadoutData set ["backpacks", ["ls_mandalorianBackpack", "ls_mandalorianBackpack_heavy"]];
_eliteLoadoutData set ["helmets", ["SFA_Sith_guard_Helmet", "SFA_Sith_commando_Helmet"]];
...
_militaryLoadoutData set ["uniforms", ["SFA_Sith_Armor"]];
_militaryLoadoutData set ["slUniforms", ["SFA_Sith_Armor_SGT"]];
_militaryLoadoutData set ["vests", ["SFA_ImpGren_Vest", "SFA_Ammo_Sash"]];
_militaryLoadoutData set ["Hvests", ["SFA_ImpLead_Vest"]];
_militaryLoadoutData set ["backpacks", ["SFA_Sith_backpack"]];
_militaryLoadoutData set ["helmets", ["SFA_Sith_Helmet_light", "SFA_Sith_Helmet"]];
...
_militiaLoadoutData set ["uniforms", ["SFA_Sith_Scout","SFA_Sith_Scout_Glac"]];
