...
["name", "Neo-Crusaders" ] call _fnc_saveToTemplate;
["nameLeader", "Cassus Fett"] call _fnc_saveToTemplate;
...
["vehiclesRivalsTanks", ["SFA_Firebrand_F_Revanite"]] call _fnc_saveToTemplate;
...
private _tunedRifles = [
	["SFA_Mando_Arkanian_rifle", "", "", "", ["SFA_Arkanian_mag"], [], ""]
];
private _enforcerRifles = [
	["SFA_Mando_Arkanian_rifle", "", "", "", ["SFA_Arkanian_mag"], [], ""]
];
private _carbines = [
	["SFA_DLA13_C", "", "", "", ["SFA_DLA13_mag"], [], ""]
];
private _gls = [
	["IDA_FA11", "", "", "", ["IDA_Blaster_Cell_Power3_40Rnd_Green"], ["IDA_HE_RifleGrenade"], ""]
];
private _mgs = [
	["SFA_T20_AC", "", "", "", ["SFA_T20_mag"], [], ""]
];
...
_loadoutData set ["NVGs", ["JLTS_NVG_droid_chip_2"]];
...
_loadoutData set ["heavyUniforms", ["SFA_Crusader_Veteran_Armor"]];
_loadoutData set ["heavyHelmets", ["SFA_Neo_Crusader_Helmet_V"]];

private _helmets = ["SFA_Neo_Crusader_Helmet_B"];

_loadoutData set ["offhelmets", ["SFA_Neo_Crusader_Helmet_FM"]];
_loadoutData set ["offuniforms", ["SFA_Crusader_FM_Armor"]];
_loadoutData set ["vests", ["ls_vest_holster_maroon"]];
_loadoutData set ["heavyVests", ["ls_vest_holster_maroon"]];
_loadoutData set ["backpacks", ["IDA_Clone_ExplosiveRig"]];
_loadoutData set ["helmets", _helmets];
_loadoutData set ["crewHelmets", ["SFA_Neo_Crusader_Helmet_B"]];
...
_crewLoadoutData set ["vests", ["ls_vest_holster_brown"]];
_crewLoadoutData set ["helmets", ["SFA_Neo_Crusader_Helmet_B"]];

private _pilotLoadoutData = _loadoutData call _fnc_copyLoadoutData;
_pilotLoadoutData set ["vests", ["ls_vest_holster_brown"]];
_pilotLoadoutData set ["helmets", ["SFA_Neo_Crusader_Helmet_B"]];
