...
_militaryLoadoutData set ["uniforms", ["SFA_Republic_Armor_TRS","SFA_Republic_Armor_light_taris"]];
_militaryLoadoutData set ["slUniforms", ["SFA_Republic_Armor_TRS"]];
_militaryLoadoutData set ["vests", ["SFA_Kama_TRS"]];
_militaryLoadoutData set ["Hvests", ["SFA_Kama_TRS","SFA_Heavy_Vest","SFA_Kama_NCO_TRS","SFA_Ammo_Sash_NCO_TRS"]];
_militaryLoadoutData set ["backpacks", ["SFA_Republic_backpack_TAR", "SFA_Republic_backpack_TAR_LR"]];
_militaryLoadoutData set ["helmets", ["SFA_Rep_Trooper_Taris_Helmet","SFA_Rep_Demo_Helmet_TRS","SFA_Rep_Underworld_Helmet_TRS"]];
...
_militiaLoadoutData set ["uniforms", ["SFA_Republic_Armor_light_taris"]];
_militiaLoadoutData set ["vests", ["ls_vest_holster_maroon"]];
_militiaLoadoutData set ["Hvests", ["IDA_KnifeHolster"]];
_militiaLoadoutData set ["backpacks", ["SFA_Republic_backpack_TAR"]];
_militiaLoadoutData set ["helmets", ["SFA_Rep_Trooper_Taris_Helmet"]];
