...
_militaryLoadoutData set ["uniforms", ["SFA_Republic_Standard_Armor","SFA_Republic_Armor_light_standard"]];
...
_militaryLoadoutData set ["helmets", ["SFA_Rep_Trooper_STND_Helmet","SFA_Rep_Demo_Helmet_STND","SFA_Balmorran_Tionese_Helmet","SFA_Rep_TrooperLightTrainee_Helmet", "SFA_Rep_TrooperLight_Helmet", "SFA_Rep_TrooperLightSTND_Helmet"]];
...
_militiaLoadoutData set ["uniforms", ["SFA_NavyHeavyTrooper_Uniform","SFA_NavyTrooper_Uniform"]];
...
_militiaLoadoutData set ["helmets", ["SFA_KOTR_TrooperHeavy_Helmet","SFA_KOTR_Trooper_Helmet"]];
