...
private _civUniforms = [
    "JMSLLTE_ScumTermo_w_F_CombatUniform",
	"U_O_R_Gorka_01_black_F",
	"JMSLLTE_EmpOfficerCoat_black_F_CombatUniform",
	"JMSLLTE_JinTrooper_suitBlack_F_CombatUniform"
];
...
private _civhats = ["JMSLLTE_Snow_1_3_helmet"
];
...
_loadoutData set ["pressVests", ["JMSLLTE_ComBag_armor"]];
