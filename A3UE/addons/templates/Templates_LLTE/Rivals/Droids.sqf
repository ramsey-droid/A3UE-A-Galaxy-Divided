...
_loadoutData set ["uniforms", [
	"JMSLLTE_EmpOfficer_CISs_F_CombatUniform"
]];
_loadoutData set ["heavyUniforms", ["JMSLLTE_EmpOfficer_CIS_F_CombatUniform"]];
...
_loadoutData set ["vests", ["JMSLLTE_IsbChest_CIS_armor"]];
