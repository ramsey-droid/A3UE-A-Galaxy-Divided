...
["nameLeader", "Saw Gurrera"] call _fnc_saveToTemplate;
...
["vehiclesRivalsAPCs", ["WM_AAC_Speeder"]] call _fnc_saveToTemplate;
["vehiclesRivalsTanks", ["3AS_AAT_Red","WM_AAC_Speeder_Rocket"]] call _fnc_saveToTemplate;
["vehiclesRivalsHelis", ["JMSLLTE_UwingHeli_veh_Saw_F"]] call _fnc_saveToTemplate;			
...
private _rifles = [
	["JMSLLTE_dh17rifle", "", "", "JMSLLTE_dh17r_holo_Scope", ["JMSLLTE_DH17_60Rnd_Mag"], [], ""]
];
...
private _pistols = ["JMSLLTE_K16pistol"];
...
_loadoutData set ["fullmask", [	"G_JMSLLTE_Facecover_dark"]];

_loadoutData set ["headgear", [
    "JMSLLTE_PathL_black_cap"
]];
...
_loadoutData set ["uniforms", [
	...
	"JMSLLTE_ScumPart_br_F_CombatUniform",
	"JMSLLTE_ScumPart_gr_F_CombatUniform",
	"JMSLLTE_ScumPart_yel_F_CombatUniform"
]];
_loadoutData set ["heavyUniforms", ["JMSLLTE_BHcom_bl_F_CombatUniform"]];

private _helmets = ["JMSLLTE_Commando_saw_helmet","JMSLLTE_CommandoH_saw_helmet","JMSLLTE_Scouttrooper_wood_helmet","JMSLLTE_EmpTiePilotTech_bounty_helmet"];

_loadoutData set ["offuniforms", ["JMSLLTE_BoOld_rust_F_CombatUniform"]];
_loadoutData set ["vests", ["JMSLLTE_CommandoBelt_armor","JMSLLTE_ComStrap_armor"]];
...
_loadoutData set ["crewHelmets", ["JMSLLTE_Xwing_Saw_helmet"]];
...
_crewLoadoutData set ["helmets", ["JMSLLTE_CommandoH_saw_helmet"]];

private _pilotLoadoutData = _loadoutData call _fnc_copyLoadoutData;
_pilotLoadoutData set ["vests", ["JMSLLTE_TermoFullVest_armor"]];
_pilotLoadoutData set ["helmets", ["JMSLLTE_Xwing_Saw_helmet"]];
