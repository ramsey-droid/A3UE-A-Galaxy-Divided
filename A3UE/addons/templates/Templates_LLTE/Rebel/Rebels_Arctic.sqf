...
["vehiclesPlane", ["3AS_SnowSpeeder","JMSLLTE_Uwing_veh_F","3AS_Civilian_Transport_03"]] call _fnc_saveToTemplate;
...
["staticMGs", ["JMSLLTE_O_vehgr_m45turret_reb_F","JMSLLTE_O_vehgr_14FDcannon_reb_F"]] call _fnc_saveToTemplate;
["staticAT", ["AGD_Shellcracker_AT","JMSLLTE_O_vehgr_DF9cannon_reb_F"]] call _fnc_saveToTemplate;
...
private _initialRebelEquipment = [
    "AGD_a180",
    "IDA_Blaster_Cell_Power2_20Rnd_green",
    "JMSLLTE_dl18pistol",
    "JMSLLTE_DL18_20rnd_Mag",
    "JMSLLTE_SnowCommandoBelt_armor",
    "JMSLLTE_SnowOfBelt_armor",
	"JMSLLTE_ComStrap_armor",
    "JMSLLTE_back_rebsmall_white",
	["3AS_RPS6_F", 15],
	["3AS_DetPack", 10],
...
if (A3A_hasTFAR && startWithLongRangeRadio) then {_initialRebelEquipment append ["tf_anprc155","JMSLLTE_back_rebradio_v1_snow"]};
if (A3A_hasTFARBeta) then {_initialRebelEquipment append ["TFAR_microdagr","ls_radios_hush98"]};
if (A3A_hasTFARBeta && startWithLongRangeRadio) then {_initialRebelEquipment append ["ls_radios_hush98","JMSLLTE_back_rebradio_v1_snow"]};
_initialRebelEquipment append ["Chemlight_blue","Chemlight_green","Chemlight_red","Chemlight_yellow"];
["initialRebelEquipment", _initialRebelEquipment] call _fnc_saveToTemplate;

private _rebUniforms = ["JMSLLTE_ScumSnow_base_F_CombatUniform",
"JMSLLTE_ScumSnowOf_base_F_CombatUniform"
...
["headgear", ["JMSLLTE_Snow_cap_helmet", "JMSLLTE_Snow_2_helmet", "JMSLLTE_Snow_1_helmet","JMSLLTE_Snow_1_3_helmet","JMSLLTE_Snow_1_white_helmet", "JMSLLTE_Snow_1_2_helmet"]] call _fnc_saveToTemplate;          //Headgear used by Rebell Ai until you have Armored Headgear.
...
_loadoutData set ["facewear", ["G_JMSLLTE_SnowGlasses","G_JMSLLTE_Facecover"]];
