...
["vehiclesBasic", ["JMSLLTE_O_veh_AA2_reb_F"]] call _fnc_saveToTemplate; 			//this line determines basic vehicles, the lightest kind available. -- Example: ["vehiclesBasic", ["B_Quadbike_01_F"]] -- Array, can contain multiple assets
["vehiclesLightUnarmed", ["JMSLLTE_O_veh_AA5_reb_F"]] call _fnc_saveToTemplate; 		//this line determines light and unarmed vehicles. -- Example: ["vehiclesLightUnarmed", ["B_MRAP_01_F"]] -- Array, can contain multiple assets
["vehiclesLightArmed",["JMSLLTE_B_veh_x34mk2_reb_F","WM_V25_Speeder","JMSLLTE_O_veh_AA2mk2_reb_F","JMSLLTE_O_veh_AA5mk2_reb_F"]] call _fnc_saveToTemplate; 		//this line determines light and armed vehicles -- Example: ["vehiclesLightArmed",["B_MRAP_01_hmg_F", "B_MRAP_01_gmg_F"]] -- Array, can contain multiple assets
...
["vehiclesAPCs", ["3AS_PX10_REB_F", "3AS_PX10_REB_UP"]] call _fnc_saveToTemplate; 				//this line determines APCs -- Example: ["vehiclesAPCs", ["B_APC_Tracked_01_rcws_F", "B_APC_Tracked_01_CRV_F"]] -- Array, can contain multiple assets
...
["vehiclesPlanesCAS", ["3AS_SnowSpeeder","JMSLLTE_YwingA4_veh_F","JMSLLTE_YwingS3_veh_F"]] call _fnc_saveToTemplate; 		//this line determines CAS planes -- Example: ["vehiclesPlanesCAS", ["B_Plane_CAS_01_dynamicLoadout_F"]] -- Array, can contain multiple assets
["vehiclesPlanesAA", ["3AS_SnowSpeeder","JMSLLTE_Awing_veh_F","JMSLLTE_Xwing_veh_F","JMSLLTE_XwingCA2_veh_F"]] call _fnc_saveToTemplate; 			//this line determines air supperiority planes -- Example: ["vehiclesPlanesAA", ["B_Plane_Fighter_01_F"]] -- Array, can contain multiple assets
...
["vehiclesMilitiaLightArmed", ["JMSLLTE_B_veh_x34mk2_reb_F", "JMSLLTE_O_veh_AA2_reb_F"]] call _fnc_saveToTemplate; //this line determines lightly armed militia vehicles -- Example: ["vehiclesMilitiaLightArmed", ["B_G_Offroad_01_armed_F"]] -- Array, can contain multiple assets
...
["vehiclesMilitiaCars", ["JMSLLTE_B_veh_v35c_reb_F"]] call _fnc_saveToTemplate; 		//this line determines militia cars (unarmed) -- Example: ["vehiclesMilitiaCars", ["B_G_Offroad_01_F"]] -- Array, can contain multiple assets

["vehiclesMilitiaAPCs", ["3AS_PX10_REB_F"]] call _fnc_saveToTemplate;     					//this line determines militia APCs

["vehiclesPolice", ["JMSLLTE_B_veh_x34mk2_reb_F"]] call _fnc_saveToTemplate; 			//this line determines police cars -- Example: ["vehiclesPolice", ["B_GEN_Offroad_01_gen_F"]] -- Array, can contain multiple assets
...
_loadoutData set ["traitorUniforms", ["JMSLLTE_ScumSnow_base_F_CombatUniform"]];		//this line determines traitor uniforms for traitor mission
_loadoutData set ["traitorVests", ["JMSLLTE_ComStrap_armor"]];			//this line determines traitor vesets for traitor mission
_loadoutData set ["traitorHats", ["H_HeadBandage_bloody_F"]];			//this line determines traitor headgear for traitor missions

_loadoutData set ["officerUniforms", ["JMSLLTE_ScumSnow_base_F_CombatUniform"]];		//this line determines officer uniforms for assassination mission
...
_loadoutData set ["officerHats", ["JMSLLTE_Snow_cap_helmet"]];	//this line determines officer headgear for assassination missions
...
_loadoutData set ["longRangeRadios", ["JMSLLTE_back_rebradio_v1_snow"]];
_loadoutData set ["atBackpacks", ["JMSLLTE_back_rebsmall_white"]];
_loadoutData set ["helmets", []];					//don't fill this line - this is only to set the variable
_loadoutData set ["slHat", ["JMSLLTE_PlastHv_wh_helmet","JMSLLTE_PlastH_wh_helmet"]];
_loadoutData set ["sniHats", ["JMSLLTE_Snow_1_2_helmet"]];

_loadoutData set ["glasses", ["G_JMSLLTE_Facecover","G_JMSLLTE_SnowGlasses"]];	//cosmetics
_loadoutData set ["goggles", ["ls_rebel_chestPouches","G_JMSLLTE_SnowGlasses"]];		//cosmetics
...
_sfLoadoutData set ["uniforms", ["JMSLLTE_ScumAlCommando_cloud_F_CombatUniform"]];
_sfLoadoutData set ["vests", ["JMSLLTE_BHcomHidden_armor","JMSLLTE_BHcomBelt_armor"]];
_sfLoadoutData set ["Hvests", ["JMSLLTE_BHcomGren_armor"]];
_sfLoadoutData set ["backpacks", ["ls_newRepublicBackpack_chestRigPouch"]];
_sfLoadoutData set ["helmets", ["JMSLLTE_CommandoH_cloud_helmet", "JMSLLTE_Commando_cloud_helmet"]];
...
_eliteLoadoutData set ["uniforms", ["JMSLLTE_ScumSnow_base_F_CombatUniform"]];
_eliteLoadoutData set ["slUniforms", ["JMSLLTE_ScumSnow_base_F_CombatUniform"]];
_eliteLoadoutData set ["vests", ["JMSLLTE_BHcomHidden_armor","JMSLLTE_BHcomBelt_armor","JMSLLTE_BHcomGren_armor"]];
_eliteLoadoutData set ["Hvests", ["JMSLLTE_ShoretrooperHeavy_armor"]];
_eliteLoadoutData set ["backpacks", ["JMSLLTE_back_rebpackH_v1_snow"]];
_eliteLoadoutData set ["helmets", ["JMSLLTE_PlastH_wh_helmet","JMSLLTE_PlastHv_wh_helmet","JMSLLTE_Snow_1_3_helmet","JMSLLTE_Snow_1_white_helmet"]];
...
["AGD_a280", "", "JMSLLTE_acc_flashlight", "", ["IDA_Blaster_Cell_Power2_20Rnd_green"], [], ""],
["AGD_a280", "", "JMSLLTE_acc_flashlight", "optic_Aco", ["IDA_Blaster_Cell_Power2_20Rnd_green"], [], ""],
["AGD_a280stock", "", "JMSLLTE_acc_flashlight", "JMSLLTE_m45_bl_Scope", ["IDA_Blaster_Cell_Power2_20Rnd_green"], [], ""],
["AGD_a280c", "", "JMSLLTE_acc_flashlight", "optic_Aco", ["IDA_Blaster_Cell_Power2_20Rnd_green"], [], ""],
...
_militaryLoadoutData set ["uniforms", ["JMSLLTE_ScumSnow_base_F_CombatUniform"]];
_militaryLoadoutData set ["slUniforms", ["JMSLLTE_ScumSnow_base_F_CombatUniform"]];
_militaryLoadoutData set ["vests", ["JMSLLTE_ComStrap_armor","JMSLLTE_SnowOfBelt_armor","JMSLLTE_SnowCommandoBelt_armor"]];
_militaryLoadoutData set ["Hvests", ["JMSLLTE_PathfinderBags_armor"]];
_militaryLoadoutData set ["backpacks", ["JMSLLTE_back_rebsmall_white","JMSLLTE_back_rebpackH_v1_snow"]];
_militaryLoadoutData set ["helmets", ["JMSLLTE_PathL_white_cap","JMSLLTE_Path_1_white_cap","JMSLLTE_Snow_1_2_helmet","JMSLLTE_Snow_1_3_helmet","JMSLLTE_Snow_1_helmet","JMSLLTE_Snow_2_helmet","JMSLLTE_Snow_1_white_helmet"]];
...
["AGD_SPK12", "", "acc_flashlight", "", ["IDA_Blaster_Cell_Power3_60Rnd_Red"], [], ""],
["AGD_a180stock", "", "", "JMSLLTE_a180_bl_Scope", ["IDA_Blaster_Cell_Power2_20Rnd_green"], [], ""],
["AGD_a300", "", "", "JMSLLTE_dh17_holo_Scope", ["IDA_Blaster_Cell_Power4_10Rnd_Red"], [], ""],
["AGD_a475", "", "", "optic_Aco", ["IDA_Blaster_Cell_Power3_60Rnd_Green"], [], ""],
["AGD_E11", "", "acc_flashlight", "", ["IDA_Blaster_Cell_Power3_40Rnd_Red"], [], ""]
]];
...
private _mgs = [
	...
	["AGD_E5C", "", "acc_flashlight", "", [], [], ""]
];

_militaryLoadoutData set ["machineGuns", _mgs];

private _marksmanRifles = [
    ["AGD_a310", "", "JMSLLTE_acc_flashlight_reb", "JMSLLTE_a300_bl_Scope", [], [], ""],
    ["AGD_dlt20a", "", "", "AGD_a280c_bl_Scope", [], [], ""]
];
...
["AGD_dh17", "", "acc_flashlight", "JMSLLTE_dh17_holo_Scope", [], [], ""],
...
_militiaLoadoutData set ["uniforms", ["JMSLLTE_ScumTermo_w_F_CombatUniform"]];
_militiaLoadoutData set ["vests", ["JMSLLTE_TermoLightVest_armor", "JMSLLTE_TermoRifleVest_armor"]];
_militiaLoadoutData set ["Hvests", ["JMSLLTE_TermoFullVest_armor"]];
_militiaLoadoutData set ["backpacks", ["JMSLLTE_back_rebpack_v1_snow"]];
_militiaLoadoutData set ["helmets", ["JMSLLTE_Snow_cap_helmet","JMSLLTE_Snow_2_helmet","JMSLLTE_PathL_white_cap","JMSLLTE_Path_1_white_cap"]];

_militiaLoadoutData set ["slRifles", [
["AGD_a180", "", "acc_flashlight", "JMSLLTE_a180_bl_Scope", ["IDA_Blaster_Cell_Power2_20Rnd_green"], [], ""],
["AGD_a180", "", "acc_flashlight", "optic_Aco", ["IDA_Blaster_Cell_Power2_20Rnd_green"], [], ""],
["AGD_a180", "", "acc_flashlight", "JMSLLTE_dh17_holo_Scope", ["IDA_Blaster_Cell_Power2_20Rnd_green"], [], ""],
["AGD_a180", "", "acc_flashlight", "optic_Aco", ["IDA_Blaster_Cell_Power2_20Rnd_green"], [], ""],
["AGD_SPK12", "", "acc_flashlight", "", ["IDA_Blaster_Cell_Power3_60Rnd_Red"], [], ""],
...
["AGD_SPK12", "", "acc_flashlight", "", ["IDA_Blaster_Cell_Power3_60Rnd_Red"], [], ""],
["AGD_dh17rifle", "", "acc_flashlight", "", ["IDA_Blaster_Cell_Power2_20Rnd_green"], [], ""],
["AGD_dh17rifle", "", "acc_flashlight", "JMSLLTE_dh17r_holo_Scope", ["IDA_Blaster_Cell_Power2_20Rnd_green"], [], ""],
...
private _marksmanRifles = [["AGD_a280", "", "acc_flashlight", "AGD_a280c_bl_Scope", [], [], ""]];
...
_crewLoadoutData set ["uniforms", ["JMSLLTE_ScumSnow_base_F_CombatUniform"]];
_crewLoadoutData set ["vests", ["JMSLLTE_SnowCommandoBelt_armor"]];
_crewLoadoutData set ["helmets", ["JMSLLTE_Snow_1_2_helmet"]];


private _pilotLoadoutData = _militaryLoadoutData call _fnc_copyLoadoutData;
_pilotLoadoutData set ["uniforms", ["JMSLLTE_ScumPilot_orange_F_CombatUniform"]];
