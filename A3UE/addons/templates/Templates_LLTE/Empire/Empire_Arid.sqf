...
_loadoutData set ["stormUniforms", ["JMSLLTE_StormTrooper_sand_F_CombatUniform"]];
_loadoutData set ["stormVests", ["JMSLLTE_StormtrooperAmmoP_armor"]];
_loadoutData set ["stormHats", ["JMSLLTE_Stormtrooper_sand_helmet"]];

_loadoutData set ["stormSniperUniforms", ["JMSLLTE_ScoutTrooper_des_F_CombatUniform"]];
_loadoutData set ["stormSniperVests", ["WM_ScoutVest"]];
_loadoutData set ["stormSniperHats", ["JMSLLTE_Scouttrooper_des_helmet"]];
...
_eliteLoadoutData set ["uniforms", ["JMSLLTE_StormTrooper_sand_F_CombatUniform"]];
_eliteLoadoutData set ["slUniforms", ["JMSLLTE_StormTrooper_sand_F_CombatUniform"]];
_eliteLoadoutData set ["vests", ["JMSLLTE_StormtrooperPauldron_med_armor","JMSLLTE_StormtrooperPauldron_black_armor","JMSLLTE_StormtrooperPauldronA_orange_armor","JMSLLTE_StormtrooperHolster_armor","JMSLLTE_StormtrooperBand_armor"]];
...
_eliteLoadoutData set ["helmets", ["JMSLLTE_Stormtrooper_sand_helmet","JMSLLTE_Stormtrooper_sand_H_helmet"]];
